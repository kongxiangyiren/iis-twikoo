...
const twikoo = dbUrl ? require('tkserver/mongo') : require('tkserver/index')
...
// 适配iisnode
const port =
  process.env.TWIKOO_PORT && process.env.TWIKOO_PORT.includes('pipe')
    ? process.env.TWIKOO_PORT
    : parseInt(process.env.TWIKOO_PORT) || 8080
